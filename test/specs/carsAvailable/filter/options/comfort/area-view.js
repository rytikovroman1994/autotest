describe('test area view', () => {
    ...
    before(' open page options', () => {
     ...
     it('check checkbox dynamic area view', () => {
        // проверяем что фильтр пуст
        browser.waitUntil(
            ()=> browser.isVisible('.avn008_filter-value-item_image') === false,
        5000, "На странице уже есть одно условие фильтра");
        // включаем чекбокс
        browser.click('div:nth-child(1) > div > div > div.avn008_option-check_checkbox-self > label');
        ...
        expect(text).to.be.equal('СИСТЕМА AREA VIEW');
        // убираем условие
        browser.click('div:nth-child(1) > div > div > div.avn008_option-check_checkbox-self > label');
     ...
     it('check more in detail about area view', () => {
