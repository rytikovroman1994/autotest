describe('test screenshots cars', () => {
    ...
    // проверяем доступность коплектаций в каточках
        it(`Make a screenshot California`, () => {
            ...
            if(browser.isVisible(`.avn008_model__wrap > div.gridcontainer > div:nth-child(3)`) === false) {
                browser.scroll(`.avn008_model__wrap > div.gridcontainer > div:nth-child(3)`, 5, 5);
            }
            // получаем имя автомобиля
            nameCar = browser.getText(`div:nth-child(3) > div > div > div.avn008_car__info > div.avn008_car__desc > h4`);
            console.log(nameCar);
            browser.scroll(`.avn008_model__wrap > div.gridcontainer > div:nth-child(3)`, 0, 0);
            // кликаем на карточку
            browser.click(`.avn008_model__wrap > div.gridcontainer > div:nth-child(3)`);
