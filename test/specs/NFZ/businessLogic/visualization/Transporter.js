describe('test screenshots cars', () => {
    ...
    // проверяем доступность коплектаций в каточках
        it(`Make a screenshot California`, () => {
            ...
            nameCar = browser.getText(`div:nth-child(8) > div > div > div.avn008_car__info > div.avn008_car__desc > h4`);
            console.log(nameCar);
            browser.scroll(`.avn008_model__wrap > div.gridcontainer > div:nth-child(8)`, 0, 0);
            // кликаем на карточку
            browser.click(`.avn008_model__wrap > div.gridcontainer > div:nth-child(8)`);
            ...
            for( let y = 1; y <= numberEquipment.length - 1; y++ ) {
                ...
                // проверяем, что карточку видно
                if(browser.isVisible(`.avn008_model__wrap > div.gridcontainer > div:nth-child(8)`) === false) {
                    browser.scroll(`.avn008_model__wrap > div.gridcontainer > div:nth-child(8)`, 5, 5);
                }
                // кликаем на карточку
                browser.click(`.avn008_model__wrap > div.gridcontainer > div:nth-child(8)`);
                // очищаем фильтр  
