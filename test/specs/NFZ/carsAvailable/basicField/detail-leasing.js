...
describe.skip('test detail leasing', () => {
    ...
    it('Choose work LK', () => {
        ...
        percentageResidualPayment = browser.getText('.nfz002_input[data-name="Остаточный платеж"] .ci001-1_suffix span');
        // получаем ежемесячный платёж
        monthlyPayment = browser.getText('.nfz002_foot__wrap .price-text');
    });

    // проверяем работу сладера Авансовый лизинговый платёж 
    ...
    it('Check the work of the slider residual payment', () => {
        ...
        browser.setValue('.nfz002_input[data-name="Остаточный платеж"] .ci001-1_input', '200000');
        browser.click('.mainStageinfo');
