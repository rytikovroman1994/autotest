...
describe('test dynamic light', () => {
    ...
    let conditions = 'Складной фаркоп';
    const ctx = {
    ...
    it(`Check checkbox ${conditions}`, () => {
        ...
        browser.helpers.checkCheckbox(conditions, 'СКЛАДНОЙ ФАРКОП', 'hitch');
     });
    ...
    it(`Check more in detail about ${conditions}`, () => {
        ...
        ctx.originalScreenshot = `snapshot/screenshotExterior/${nameBrowser}/hitch.png`;
