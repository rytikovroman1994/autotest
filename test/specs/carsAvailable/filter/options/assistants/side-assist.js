describe('test side assist', () => {
    ...
    before(' open page options', () => {
     ...
     it('check checkbox side assist', () => {
        ...
        browser.moveToObject('.checkbox[data-name="Система Side Assist"]');
        // включаем чекбокс
        browser.click('.checkbox[data-name="Система Side Assist"]');
     ...
     it('check more in detail side assist', () => {
        // перемещаем курсор к чекбоксу
        browser.moveToObject('.avn008_option-check_more[data-name="checkbox%Система Side Assist'); 
